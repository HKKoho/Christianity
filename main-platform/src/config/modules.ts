...
export const modules: ModuleConfig[] = [
  {
    ...
    description: 'Explore the rich tapestry of Christian culture to experience in person',
  ...
  },
  {
    ...
    description: 'Advanced theological research platform with 11 LLM models',
